...
mix.js([
    ...
    .copy('resources/js/summernote-cleaner.js', 'public/js/summernote-cleaner.js', true)
    .copy('resources/js/summernote-image-attributes.js', 'public/js/summernote-image-attributes.js', true)
    .copy('resources/js/summernote-twitter.js', 'public/js/summernote-twitter.js', true)
