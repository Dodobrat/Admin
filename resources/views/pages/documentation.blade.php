...
&lt;/div&gt;</pre>
                ...
                <p>Below code is used for (pixeladmin-inverse) logo you can change it by text or image or icon, if your image height is bigger then 60px, you need to resize your logo or give height="60" to your logo image.</p> <pre class="prettyprint">
&lt;!-- Logo --&gt;
    ...
    &lt;/a&gt;
        ...
        &lt;!-- Left navbar-header --&gt;
             ...
             &lt;!-- Left navbar-header end --&gt;
                    ...
                    <div class="col-md-4 col-sm-4"><img src="../plugins/images/docs/sidebar.jpg" alt="sidebar" /></div>
                </div>
                <hr>
                <h3 class="box-title">Page content, right sidebar and footer</h3>
                <p>Below code is used for content, right sidebar and footer in all pages</p> <pre class="prettyprint">
&lt;!-- Page Content --&gt;
         &lt;div id="page-wrapper"&gt;
